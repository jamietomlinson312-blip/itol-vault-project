...
function displayPosts(){
    ...
    if (newArray){
        newArray.slice(-5).forEach((element, index) => {
            ...
            if (index == 0){
                newDiv.classList = "p-5 col-span-1 sm:col-span-2 sm:row-span-1 flex flex-col gap-3 bg-white rounded-sm shadow-md"; 
                ...
                newDiv.classList = "p-5 col-span-1 sm:col-span-1 sm:row-span-1 flex flex-col gap-3 bg-neutral-200 rounded-sm shadow-md"; 
                ...
                newDiv.classList = "p-5 col-span-1 sm:col-span-3 sm:row-span-1 flex flex-col gap-3 bg-neutral-200 rounded-sm shadow-md"; 
                date.classList = "text-neutral-400 text-xs font-bold";
                title.classList = "text-lg font-extrabold";
                body.classList = "text-xs text-neutral-600";
            }
            ...
            element.tags.forEach((tagList) => { // looping through tag list and rendering in card 
